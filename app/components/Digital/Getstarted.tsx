        ...
        <>
            <div className=" inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto md:ml-6 sm:pr-0">
                ...
                <div className='my-7 text-center lg:text-start'>
                    <button type="button" className="text-xl font-semibold bg-white text-gray-800 py-4 px-12 rounded-full border-2 border-gray-800 hover:border-gray-500 shadow-lg hover:shadow-xl transform transition-all duration-300 hover:scale-110 focus:outline-none" onClick={openModal}>
                        Get Started
                    </button>
                </div>
            </div>
