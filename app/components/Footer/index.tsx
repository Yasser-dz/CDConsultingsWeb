            ...
            <div className="mx-auto max-w-2xl pt-48 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4'>
                        <h3 className='text-white text-4xl font-semibold leading-9 mb-4 lg:mb-20'> CD Consultings</h3>
                        <div className='flex gap-4'>
                            ...
                            {/* LinkedIn Icon */}
                            <div className='footer-icons'>
                                <Link href="https://linkedin.com"><Image src={'/images/footer/linkedin.jpg'} alt="linkedin" width={20} height={20} /></Link>
                            </div>
                        </div>
                    </div>
